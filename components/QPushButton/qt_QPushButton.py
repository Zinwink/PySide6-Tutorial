...
class Form(QDialog):
    def __init__(self, parent=None):
        ...
        self.button_image.toggle()
        self.button_image.setIcon(QIcon(QPixmap("./python.png")))
        ...
        self.button_shortcut.setDefault(True) # 默认按钮 Enter/Return 时自动触发
    ...
    def button_click(self, button:QPushButton):
        if button.isChecked():
