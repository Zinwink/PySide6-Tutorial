...
import urllib.parse
from PySide6.QtWidgets import QApplication, QWidget, QMainWindow, QLineEdit,QTextBrowser, QToolBar, QVBoxLayout, QPushButton,QFrame,QHBoxLayout
...
class TextBrowser(QMainWindow):
    ...
    def initUI(self):
        ...
        self.textBrowser.setSource(QUrl("./textBrowser.html"))
        ...
        frame = QFrame()
        frame.setFrameShadow(QFrame.Sunken)  # 凹陷阴影
        ...
        self.setWindowTitle("QTextBrowser案例")
