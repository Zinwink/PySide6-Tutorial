...
"""
(1)对 pg 的设置要放在主程序初始化设置 self.setupUi(self)之前,否则效果呈现不出
来,因为在 setupUi()函数中已经按照默认方式设置好了绘图的背景色、文本颜色、线
条颜色等。
"""
...
class pyqtgraphDemo(QMainWindow):
    def __init__(self, parent=None):
        ...
        layout.addWidget(self.plot1, stretch=2) #拉伸比例为2
        layout.addLayout(layoutH2, stretch=1) #拉伸比例为1 2：1
    ...
    def onButtonLayout(self):
        ...
        '''
        纯散点图（无连接线）
        pen=None​​​​禁用折线连接​​，即只显示散点，不绘制数据点之间的连线。

        symbol='t'​​
        设置散点的 ​​标记形状​​ 为 ​​三角形（triangle）​​。
        其他常见选项：
            'o'：圆形（默认）
            's'：方形
            '+'：加号
        ...
        symbolPen=None​​​禁用标记的边框线​​。
        symbolSize=10​​设置标记的 ​​大小为 10 像素​​。
        symbolBrush=(100, 100, 255, 50)​​设置标记的 ​​填充颜色​​ 为 ​​半透明的浅蓝色​​。
        '''
